...
public class InvestorAllAdapter extends RecyclerView.Adapter<InvestorAllAdapter.ViewHolder> {
    Context c;
    ArrayList<Investor> list;
    int type;
    SharedPref sh;

    public InvestorAllAdapter(Context c, ArrayList<Investor> list, int type) {
        this.c = c;
        this.list = list;
        this.type = type;
        sh = new SharedPref(c);
    ...
    @NonNull
    @Override
    public InvestorAllAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view_investor, null);
        InvestorAllAdapter.ViewHolder rcv = new InvestorAllAdapter.ViewHolder(c, layoutView);
        return rcv;
    }

    @Override
    public void onBindViewHolder(@NonNull InvestorAllAdapter.ViewHolder holder, int position) {
      ...
      holder.con.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              Gson g=new Gson();
              Intent intent = new Intent(c, InvestorProfile.class);
