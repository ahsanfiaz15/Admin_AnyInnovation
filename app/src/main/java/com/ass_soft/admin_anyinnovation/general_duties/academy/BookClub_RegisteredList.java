...
public class BookClub_RegisteredList extends AppCompatActivity {
    ...
    private void getUsers() {
        final ProgressDialog progressDialog = new ProgressDialog(BookClub_RegisteredList.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            if(response.startsWith("Invalid")){
                                ...
                                LinearLayoutManager lLayout = new LinearLayoutManager(BookClub_RegisteredList.this, LinearLayoutManager.VERTICAL, false);
                                MasterClassRegisterAdapter adapter=new MasterClassRegisterAdapter(BookClub_RegisteredList.this,list);
