...
public class GeneralDuties_RegisteredList extends AppCompatActivity {
       ...
       /* itemViewEntrepreneur = findViewById(R.id.itemViewEntrepreneur);
        ...
        itemViewEntrepreneur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(GeneralDuties_RegisteredList.this, Entrepreneur_Profile.class);
    ...
    private void getUsers() {
        final ProgressDialog progressDialog = new ProgressDialog(GeneralDuties_RegisteredList.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                        ...
                        try {
                            if(response.startsWith("Invalid")){
                               ...
                               RecyclerView RV=findViewById(R.id.RV);
                                LinearLayoutManager lLayout = new LinearLayoutManager(GeneralDuties_RegisteredList.this, LinearLayoutManager.VERTICAL, false);
                                MasterClassRegisterAdapter adapter=new MasterClassRegisterAdapter(GeneralDuties_RegisteredList.this,list);
            ...
            protected Map<String, String> getParams()
            {
                ...
                // the POST parameters:
                params.put("tb","master_class_reg");
