...
public class InvestorApproveAccountDetails extends AppCompatActivity {
    Investor m;
    String status="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_investor_approve_account_details);
        Gson g=new Gson();
    ...
    private void block() {
        final ProgressDialog progressDialog = new ProgressDialog(InvestorApproveAccountDetails.this);
    ...
    public void messageInvestor(View view) {
        ...
        Intent intent = new Intent(InvestorApproveAccountDetails.this, Chat.class);
